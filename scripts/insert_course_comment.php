<?php 
    ...
    if(isset($_POST['sub'])) {
        ...
        $insert = "INSERT INTO course_comments (c_id, user_id, comm_date, course_comment, course_comm_img, course_comm_img_type) VALUES ('".$_POST['c_id']."', '" . $_SESSION['user_id'] . "', NOW(), '$post','$img_upload', '$img_type')";
